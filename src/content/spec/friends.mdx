...
export const site = {
  name: "前格里芬管理员兼美铃P暖霜",
  desc: "原铁绝三家迦努 双朝两朝元老 终异追棕雪",
  url: "https://114350234.xyz",
  avatar: "https://github.com/GZLns.png",
};
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">提交友链申请</p>
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed mb-3">点击下方按钮填写表单，提交后我会收到通知并尽快审核</p>
              <a href="https://github.com/GZLns/Firefly/issues/new?template=04-friend-link.yml" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-(--primary) text-white text-sm font-medium hover:opacity-90 transition-opacity">
